...
namespace cppcoro
{
	...
	namespace detail
	{
		...
		public:
			...
			cppcoro::stdcoro::suspend_always initial_suspend() const noexcept
			{
				return {};
			}
		...
		private:
			...
			cppcoro::stdcoro::coroutine_handle<> m_consumerCoroutine;
		...
		public:
			...
			async_generator_yield_operation(cppcoro::stdcoro::coroutine_handle<> consumer) noexcept
				: m_consumer(consumer)
			{}
			...
			cppcoro::stdcoro::coroutine_handle<>
			await_suspend([[maybe_unused]] cppcoro::stdcoro::coroutine_handle<> producer) noexcept
			{
				return m_consumer;
			}
		...
		private:
			...
			cppcoro::stdcoro::coroutine_handle<> m_consumer;
		...
		protected:
			...
			async_generator_advance_operation(
				...
				cppcoro::stdcoro::coroutine_handle<> producerCoroutine) noexcept
		...
		public:
			...
			cppcoro::stdcoro::coroutine_handle<>
				await_suspend(cppcoro::stdcoro::coroutine_handle<> consumerCoroutine) noexcept
			{
		...
		protected:
			...
			cppcoro::stdcoro::coroutine_handle<> m_producerCoroutine;
		...
		class async_generator_iterator final
		{
			...
			using handle_type = cppcoro::stdcoro::coroutine_handle<promise_type>;
	...
	public:
		...
		explicit async_generator(promise_type& promise) noexcept
			: m_coroutine(cppcoro::stdcoro::coroutine_handle<promise_type>::from_promise(promise))
		{}
	...
	private:
		...
		cppcoro::stdcoro::coroutine_handle<promise_type> m_coroutine;
	...
	namespace detail
	{
		...
		public:
			...
			bool await_suspend(cppcoro::stdcoro::coroutine_handle<> producer) noexcept;
		...
		inline bool async_generator_yield_operation::await_suspend(
			cppcoro::stdcoro::coroutine_handle<> producer) noexcept
		{
		...
		public:
			...
			bool await_suspend(cppcoro::stdcoro::coroutine_handle<> consumerCoroutine) noexcept
			{
				m_promise->m_consumerCoroutine = consumerCoroutine;
