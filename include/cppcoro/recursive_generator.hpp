...
namespace cppcoro
{
	...
	public:
		...
		public:
			...
			cppcoro::stdcoro::suspend_always initial_suspend() noexcept
			{
				return {};
			}

			cppcoro::stdcoro::suspend_always final_suspend() noexcept
			{
				return {};
			}
			...
			cppcoro::stdcoro::suspend_always yield_value(T& value) noexcept
			{
			...
			auto yield_value(recursive_generator& generator) noexcept
			{
				struct awaitable
				{
					...
					void await_suspend(cppcoro::stdcoro::coroutine_handle<promise_type>) noexcept
					{}
			...
			template<typename U>
			cppcoro::stdcoro::suspend_never await_transform(U&& value) = delete;

			void destroy() noexcept
			{
				cppcoro::stdcoro::coroutine_handle<promise_type>::from_promise(*this).destroy();
			}
			...
			{
				return cppcoro::stdcoro::coroutine_handle<promise_type>::from_promise(*this).done();
			}
		...
		private:
			...
			{
				cppcoro::stdcoro::coroutine_handle<promise_type>::from_promise(*this).resume();
			}
