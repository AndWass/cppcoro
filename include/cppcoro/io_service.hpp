...
namespace cppcoro
{
	...
	public:
		...
		void await_suspend(cppcoro::stdcoro::coroutine_handle<> awaiter) noexcept;
	...
	private:
		...
		cppcoro::stdcoro::coroutine_handle<> m_awaiter;
	...
	public:
		...
		void await_suspend(cppcoro::stdcoro::coroutine_handle<> awaiter);
		void await_resume();
