...
namespace cppcoro
{
	namespace detail
	{
		...
		{
			using coroutine_handle_t = cppcoro::stdcoro::coroutine_handle<sync_wait_task_promise<RESULT>>;
		...
		public:
			...
			auto await_transform(get_promise_t)
			{
				...
				public:
					...
					void await_suspend(cppcoro::stdcoro::coroutine_handle<>) noexcept {}
		...
		{
			using coroutine_handle_t = cppcoro::stdcoro::coroutine_handle<sync_wait_task_promise<void>>;
		...
		public:
			...
			using coroutine_handle_t = cppcoro::stdcoro::coroutine_handle<promise_type>;
