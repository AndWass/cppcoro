...
namespace cppcoro
{
	namespace detail
	{
		...
		public:
			...
			using coroutine_handle_t = cppcoro::stdcoro::coroutine_handle<when_all_task_promise<RESULT>>;
		...
		public:
			...
			using coroutine_handle_t = cppcoro::stdcoro::coroutine_handle<when_all_task_promise<void>>;
