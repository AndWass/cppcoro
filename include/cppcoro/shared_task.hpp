...
namespace cppcoro
{
	...
	namespace detail
	{
		...
		class shared_task_promise_base
		{
			...
			struct final_awaiter
			{
				...
				void await_suspend(cppcoro::stdcoro::coroutine_handle<PROMISE> h) noexcept
				{
		...
		public:
			...
			cppcoro::stdcoro::suspend_always initial_suspend() noexcept { return {}; }
			...
			bool try_await(shared_task_waiter* waiter, cppcoro::stdcoro::coroutine_handle<> coroutine)
			{
	...
	private:
		...
		struct awaitable_base
		{
			...
			bool await_suspend(cppcoro::stdcoro::coroutine_handle<> awaiter) noexcept
			{
	...
	public:
		...
		explicit shared_task(cppcoro::stdcoro::coroutine_handle<promise_type> coroutine)
			: m_coroutine(coroutine)
		{
	...
	namespace detail
	{
		...
		shared_task<T> shared_task_promise<T>::get_return_object() noexcept
		{
			return shared_task<T>{
				cppcoro::stdcoro::coroutine_handle<shared_task_promise>::from_promise(*this)
			};
		}
