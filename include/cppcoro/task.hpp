...
namespace cppcoro
{
	...
	namespace detail
	{
		class task_promise_base
		{
			...
			struct final_awaitable
			{
				...
				cppcoro::stdcoro::coroutine_handle<> await_suspend(
					cppcoro::stdcoro::coroutine_handle<PROMISE> coro) noexcept
				{
				...
				template<typename PROMISE>
				CPPCORO_NOINLINE
				void await_suspend(cppcoro::stdcoro::coroutine_handle<PROMISE> coroutine)
				{
		...
		public:
			...
			{
				return cppcoro::stdcoro::suspend_always{};
			}
...
#if CPPCORO_COMPILER_SUPPORTS_SYMMETRIC_TRANSFER
			void set_continuation(cppcoro::stdcoro::coroutine_handle<> continuation) noexcept
			{
				m_continuation = continuation;
			}
#else
			bool try_set_continuation(cppcoro::stdcoro::coroutine_handle<> continuation)
			{
				m_continuation = continuation;
		...
		private:
			...
			cppcoro::stdcoro::coroutine_handle<> m_continuation;
	...
	private:
		...
		struct awaitable_base
		{
			...
			awaitable_base(cppcoro::stdcoro::coroutine_handle<promise_type> coroutine) noexcept
...
#if CPPCORO_COMPILER_SUPPORTS_SYMMETRIC_TRANSFER
			cppcoro::stdcoro::coroutine_handle<> await_suspend(
				cppcoro::stdcoro::coroutine_handle<> awaitingCoroutine) noexcept
			{
				m_coroutine.promise().set_continuation(awaitingCoroutine);
				return m_coroutine;
			}
#else
			bool await_suspend(cppcoro::stdcoro::coroutine_handle<> awaitingCoroutine) noexcept
			{
	...
	public:
		...
		explicit task(cppcoro::stdcoro::coroutine_handle<promise_type> coroutine)
			: m_coroutine(coroutine)
		{}
	...
	namespace detail
	{
		...
		{
			return task<T>{ cppcoro::stdcoro::coroutine_handle<task_promise>::from_promise(*this) };
		}

		inline task<void> task_promise<void>::get_return_object() noexcept
		{
			return task<void>{ cppcoro::stdcoro::coroutine_handle<task_promise>::from_promise(*this) };
		}
